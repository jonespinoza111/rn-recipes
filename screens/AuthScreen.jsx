  ...
  return (
    <View className="flex flex-1 justify-center items-center bg-white pt-[50px]">
        <View className="bg-white w-[150%] gap-x-3 gap-y-3 flex flex-row justify-center flex-wrap h-auto">
          {[FrenchCuisine, BreakfastImage, AfricanCuisine, MexicanCuisine, LatinCuisine, GreekCuisine, JapaneseCuisine].map((el => (
            <Image className="w-[125px] h-[155px] rounded-2xl" source={el} />
          )))}
        </View>
        <ScrollView className="w-[100%] px-[30px]" contentContainerStyle={{ flexGrow: 1, justifyContent: 'center' }} >
