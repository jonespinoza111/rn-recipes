  ...
  return (
    <View className="w-[100%]">
        <View className="w-[100%] bg-white text-white flex flex-row justify-between items-center border-b-2 border-[#dadada] pl-[5px] pr-[5px] py-[10px]">
            <Text className="bg-black text-orange-300 rounded py-2 px-4 text-[17px]">{title}</Text>
            <TouchableOpacity className="px-[10px] flex justify-center items-center" onPress={() => setShowContent((prev) => !prev)}>
                {showContent ? (
